...
contract ProgressiveRoyalties is ITransferAwareRoyalties, Initializable {
     ...
     *              at 1 the absolute bps value reduction
     */
    ...
    function label() public override pure returns (string memory) {
        return "Progressive Decaying 1.0";
    }
    ...
    function supportsInterface(bytes4 interfaceId) public pure override returns (bool) {
        return type(IERC2981).interfaceId == interfaceId || 
                type(IRoyalties).interfaceId == interfaceId || 
                type(ITransferAwareRoyalties).interfaceId == interfaceId;
    }
}